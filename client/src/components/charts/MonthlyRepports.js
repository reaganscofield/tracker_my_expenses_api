        ...
        if (res.data) {
          ...
          if (monthly && typeof monthly === "object") {
            monthly.forEach(element => {
              if (this.state.labels.indexOf(moment(element.month).format("MMMM YYYY")) === -1) {
                this.state.labels.push(moment(element.month).format("MMMM YYYY"));
